...
La PCA s'installe sur les systèmes de types Windows exclusivement. Après avoir téléchargé le fichier PCAFA.zip comme détaillé ci-dessus, décompressez-le dans le dossier de votre choix (par exemple et ci-après *PCAFA*).
...
4.  Consultez ensuite le manuel d'utilisation (accessible via le menu *Aide -> Documentation* dans la PCA) pour configurer la PCA à votre convenance.
