...
| | |
| :--- | :--- |
| **Télécharger PCA version libre accès (Windows), PCAFA.zip** | [[PCAFA.zip]](PCAFA.zip) |

---

## Procédure d'installation

La PCA s'installe sur les systèmes de types Windows exclusivement. Après avoir téléchargé le fichier [**PCAFA.zip**](PCAFA.zip) ci-dessus, décompressez-le dans le dossier de votre choix (par exemple et ci-après *PCAFA*).
